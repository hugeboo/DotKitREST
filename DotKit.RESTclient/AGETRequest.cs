...
{
    /// <summary>
    /// Абстрактный GET-запрос
    /// </summary>
    /// <typeparam name="Tresponse">Тип объекта, возвращаемого в качестве ответа</typeparam>
    public abstract class AGETRequest<Tresponse> : ARequest<Tresponse>
    {
        public AGETRequest(RequestSettings settings)
            : base(settings)
        {
        }
        ...
        public override Tresponse Execute(string path, object data)
        {
            ...
            var request = MakeRequest(httpAddr, "GET");
